...
public class TFDevice {
	...
	Class<? extends Device> deviceClass; // DeviceFactory.getDeviceClass(deviceIdentifier)
	State state;	
...
//	char position
	public static TFDevice create(String uid, String connectedUid,char position, 
			short[] hwv, short[] fwv, int deviceIdentifier, 
			short enumerationType) {
		TFDevice dev = new TFDevice();
		dev.setUid(uid);
